...
void DynamixelMotorXL430::goalVelocity(int32_t aVelocity, int timeout=100) {
  if (aVelocity < 0) {
	  aVelocity = -aVelocity | 1024;
  }
...
void DynamixelMotorXL430::syncGoalVelocity(uint32_t aVelocity, int timeout=100) {
