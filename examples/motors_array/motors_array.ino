...
DynamixelMotorXL430 *motors[NUMBER_WHEELS];
...
void setup() {
  ...
  for (int indexMotor=0; indexMotor<NUMBER_WHEELS; ++indexMotor) {
	  motors[indexMotor] = new DynamixelMotorXL430(idWheels[indexMotor]);
  }
